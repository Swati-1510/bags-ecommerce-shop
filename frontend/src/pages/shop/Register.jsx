          ...
          <>
            <div className="text-center">
              ...
              <p className="mt-2 text-xs tracking-wider text-[#707070] uppercase">
                Create your S3 membership account
              </p>
            </div>
            ...
            <div className="relative flex py-2 items-center">
              ...
              <span className="flex-shrink mx-4 text-[10px] text-stone-400 font-bold uppercase tracking-widest">or sign up with email</span>
              <div className="flex-grow border-t border-stone-200"></div>
            </div>

            <form className="space-y-5" onSubmit={handleRegisterSubmit}>
              <div>
                <label htmlFor="name" className="block text-xs font-semibold tracking-wider text-[#111111] uppercase">
                  Full Name
                </label>
                <input
                  id="name"
              ...
              >
                {loading ? 'Sending Verification OTP...' : 'Register'}
              </button>
            </form>

            <div className="text-center mt-6 text-xs text-[#707070] tracking-wide">
              Already have an account?{' '}
              <Link to="/login" className="font-semibold text-[#111111] hover:text-[#7A624E] underline transition-colors">
                Sign In Here
              </Link>
            </div>
          </>
